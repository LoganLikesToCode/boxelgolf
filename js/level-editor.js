class LevelEditor extends THREE.Group {
                    ...
                    if (this.mode == 'sample') {
                        ...
                        if (this.mode != 'erase') {
                            ...
                            if (this.selection.children.length == 1) {
                                ...
                                if (selected && selected.userData && selected.userData.hasOwnProperty('text')) {
                                ...
                                if (object.userData && object.userData.hasOwnProperty('text')) {
    ...
    saveLevel() {
        ...
        var key = data.key;
        var objects = [app.weather, app.player, app.player.prediction].concat(app.level.getObjectsByProperty('name', 'out-of-bounds'));
