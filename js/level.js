class Level extends THREE.Group {
    constructor() {
        ...
        this.clock.refreshMax = 120; // Level max limit in seconds
        this.objects.name = '';
        this.objects.key = '';
        this.debug = false;
    }
    ...
    loadLevel(objects, hide = true) {
        ...
        this.add(this.objects, this.background, this.editor, app.weather, app.player, app.player.prediction, app.multiplayer);
        this.loadPlayer();
